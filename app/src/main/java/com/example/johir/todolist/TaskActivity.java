...
public class TaskActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (taskId > 0)
        {
            ...
            //Log.i("Position", spCategory.getSelectedItem().toString());
            spCategory.setSelection(getCategoryIndex(task.getCategoryId()));
    ...
    {
        if(edTaskName.getText().toString().trim().equals(""))
        {
