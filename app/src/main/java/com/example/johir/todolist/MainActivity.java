package com.example.johir.todolist;
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.id_message:
                ...
                Task messageTask = tasks.get(menuInfo.position);
                //intent.setData(Uri.parse("tel:" + mobileNumberTextView.getText().toString()));
                intent.putExtra("sms_body", "Date: " + Utility.getDateFromInt(messageTask.getDate()) + ", Task Name: " + messageTask.getName() + " , Description: " + messageTask.getDescription());
