...
public class TaskAdapter extends ArrayAdapter<Task> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvName.setText(taskList.get(position).getName().toString());
        ...
        viewHolder.tvDescription.setText(taskList.get(position).getDescription().toString());
        viewHolder.tvDate.setText(Utility.dateRemaining(taskList.get(position).getDate()));
